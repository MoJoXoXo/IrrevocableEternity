...
void images(){
	...
	natanRun[0] = iLoadImage("run\\2.png"); natanRun[1] = iLoadImage("run\\3.png"); natanRun[2] = iLoadImage("run\\4.png"); natanRun[3] = iLoadImage("run\\5.png"); natanRun[4] = iLoadImage("run\\6.png");

	natanJumpUpIndex = iLoadImage("Jump\\jump2.png");
	natanJumpDownIndex = iLoadImage("Jump\\jump3.png");

	natanStand[0] = iLoadImage("idle\\idle1.png"); natanStand[1] = iLoadImage("idle\\idle2.png"); natanStand[2] = iLoadImage("idle\\idle3.png"); natanStand[3] = iLoadImage("idle\\idle4.png");

	menuBG[0] = iLoadImage("menu\\menuBG.jpg"); menuBG[1] = iLoadImage("menu\\menuwindow.png");

	desertBG = iLoadImage("background\\desert.PNG");

	startupImg[0] = iLoadImage("menu\\startup1.png"); startupImg[1] = iLoadImage("menu\\startup10.png"); startupImg[2] = iLoadImage("menu\\startup2.png"); startupImg[3] = iLoadImage("menu\\startup3.png"); startupImg[4] = iLoadImage("menu\\startup4.png"); startupImg[5] = iLoadImage("menu\\startup5.png");

	/*
	upperBg[0]=iLoadImage("background\\desert.PNG");
	upperBg[1]=iLoadImage("background\\desert.PNG");
	upperBg[2]=iLoadImage("background\\desert.PNG");
	lowerBg[0]=iLoadImage("background\\desert.PNG");
	lowerBg[1] = iLoadImage("background\\desert.PNG");
	lowerBg[2] = iLoadImage("background\\desert.PNG");
