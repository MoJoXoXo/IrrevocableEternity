...
=======
		if (mx >= SCREENWIDTH*0.46 && mx <= SCREENWIDTH*0.545 && my >= SCREENHEIGHT*0.52 && my <= SCREENHEIGHT*0.66)
			gameState = 1;
		//sound
		else if (mx >= SCREENWIDTH*0.563 && mx <= SCREENWIDTH*0.613 && my >= SCREENHEIGHT*0.44 && my <= SCREENHEIGHT*0.54){
			//gameState = 2;
			if (musicOn){
				musicOn = false;
				PlaySound(0, 0, 0);
		...
		//standing
		else if (mx >= SCREENWIDTH*0.4 && mx <= SCREENWIDTH*0.45 && my >= SCREENHEIGHT*0.44 && my <= SCREENHEIGHT*0.54)
			gameState = 3;
		//setting
		else if (mx >= SCREENWIDTH*0.4 && mx <= SCREENWIDTH*0.45 && my >= SCREENHEIGHT*0.31 && my <= SCREENHEIGHT*0.39)
			gameState = 4;
		//about us
		else if (mx >= SCREENWIDTH*0.482 && mx <= SCREENWIDTH*0.525 && my >= SCREENHEIGHT*0.31 && my <= SCREENHEIGHT*0.39)
			gameState = 5;
		//instruction
		else if (mx >= SCREENWIDTH*0.563 && mx <= SCREENWIDTH*0.613 && my >= SCREENHEIGHT*0.31 && my <= SCREENHEIGHT*0.39)
			gameState = 6;
}
